...
namespace Net.DACircularProgress.iOS
{
	...
	{
		// extern double DACircularProgressVersionNumber;
		[Field ("DACircularProgressVersionNumber", "__Internal")]
		double DACircularProgressVersionNumber { get; }

		// extern const unsigned char[] DACircularProgressVersionString;
		[Field ("DACircularProgressVersionString", "__Internal")]
		byte[] DACircularProgressVersionString { get; }
	}
}
